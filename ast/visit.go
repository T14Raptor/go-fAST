...
func (n *BindingTarget) VisitChildrenWith(v Visitor) {
	...
	case BindingTargetInvalid:
		(*InvalidExpression)(unsafe.Pointer(&n.ptr)).VisitWith(v)
...
func (n *Expression) VisitChildrenWith(v Visitor) {
	...
	case ExprBoolLit:
		(*BooleanLiteral)(unsafe.Pointer(&n.ptr)).VisitWith(v)
	case ExprCall:
	...
	case ExprNullLit:
		(*NullLiteral)(unsafe.Pointer(&n.ptr)).VisitWith(v)
	case ExprNumLit:
	...
	case ExprSuper:
		(*SuperExpression)(unsafe.Pointer(&n.ptr)).VisitWith(v)
	case ExprThis:
		(*ThisExpression)(unsafe.Pointer(&n.ptr)).VisitWith(v)
	case ExprTmplLit:
...
func (n *Statement) VisitChildrenWith(v Visitor) {
	...
	switch n.kind {
	case StmtBad:
		(*BadStatement)(unsafe.Pointer(&n.ptr)).VisitWith(v)
	case StmtBlock:
		(*BlockStatement)(n.ptr).VisitWith(v)
	case StmtBreak:
	...
	case StmtDebugger:
		(*DebuggerStatement)(unsafe.Pointer(&n.ptr)).VisitWith(v)
	case StmtDoWhile:
		(*DoWhileStatement)(n.ptr).VisitWith(v)
	case StmtEmpty:
		(*EmptyStatement)(unsafe.Pointer(&n.ptr)).VisitWith(v)
	case StmtExpression:
